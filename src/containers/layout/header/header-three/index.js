...
const Header = ({ props, ...styles }) => {
    ...
    const menuArr = headerData.allContentfulDfsMainMenu.edges;
                                ...
                                <HeaderMain top>
                                    ...
                                    <HeaderCol right>
                                        <HeaderElement {...phoneElStyle}>
                                            <HeaderInfoItem>
                                                <Anchor path="tel:4401738506283">
                                                    <MdPhone />
                                                    <Text as="strong">+44-01738-506283</Text>
                                                </Anchor>
                                            </HeaderInfoItem>
                                        </HeaderElement>
                                        <HeaderElement>
                                            <HeaderInfoItem>
                                                <Text>
                                                    <MdPlace />
                                                    <Text as="span">info@difitalflexsolutions.com</Text>
                                                </Text>
                                            </HeaderInfoItem>
                                        </HeaderElement>
                                    </HeaderCol>
